...
import { tables } from "@/src/shared/modules/helpers/mocks";

const CustomDatePicker = dynamic(() => import("./date-picker"));
const FloorPlan = dynamic(() => import("./floor-plan"));
const TimeSlots = dynamic(() => import("./time-slots"));
const BookingSummary = dynamic(() => import("./booking-sumary"));
